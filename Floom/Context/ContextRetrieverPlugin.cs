...
public class ContextRetrieverPlugin : FloomPluginBase
{
    private ContextRetrieverPluginConfig _config;
    private EmbeddingsProvider? _embeddingsProvider = null;

    public ContextRetrieverPlugin()
    {
    }
    ...
    public override void Initialize(PluginContext context)
    {
        ...
        _config = new ContextRetrieverPluginConfig(context.Configuration.Configuration);
        ...
        EmbeddingsConfiguration embeddingsConfiguration)
    {
        ...
        splitText = await documentManager.ExtractTextAsync(".pdf", fileBytes,
            extractionMethod,
